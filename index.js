...
const CURRENCY_EXCHANGE_DATA_URL = 'https://bank.gov.ua/NBUStatService/v1/statdirectory/exchange?json'
...
const exchangeCurrency = async (amount, fromCurrency, toCurrency = DEFAULT_CURRENCY) => {
  ...
  const toCurrencyData = currencyExchangeData.find(
    foundCurrency(toCurrency)
  )
